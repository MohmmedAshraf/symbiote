...
export function createMcpServer(
    ...
    server.tool(
        ...
        'Returns the developer\'s coding style, preferences, and anti-patterns.',
        {
            ...
            taskContext: z
                ...
                .optional()
                .describe(
                    'Description of the current task for relevance filtering'
                ),
        },
        async (input) => ({
            content: [
                {
                    type: 'text' as const,
                    text: JSON.stringify(
                        handleGetDeveloperDna(ctx, input),
                        null,
                        2
                    ),
                },
    ...
    server.tool(
        ...
        'Returns everything about a specific file: symbols, dependencies, dependents, constraints, decisions.',
        {
            filePath: z
                .string()
                .describe('The file path to get context for'),
        },
        async (input) => ({
            content: [
                {
    ...
    server.tool(
        ...
        'Search the code graph: find symbols by name, trace dependencies or dependents.',
        {
            query: z
                .string()
                .describe(
                    'Search query or node ID for dependency/dependent lookup'
                ),
            type: z
                .enum(['search', 'dependencies', 'dependents'])
                .describe('Query type'),
        },
        async (input) => ({
            content: [
    ...
    server.tool(
        ...
        'Returns active constraints, optionally scoped to a file or module.',
        {
            scope: z
                ...
                .optional()
                .describe(
                    'File path or module to scope constraints to'
                ),
        },
        async (input) => ({
            content: [
                {
                    type: 'text' as const,
                    text: JSON.stringify(
                        handleGetConstraints(ctx, input),
                        null,
                        2
                    ),
                },
    ...
    server.tool(
        ...
        'Returns architectural decisions, optionally scoped to a file or module.',
        {
            scope: z
                ...
                .optional()
                .describe(
                    'File path or module to scope decisions to'
                ),
        },
        async (input) => ({
            content: [
    ...
    server.tool(
        ...
        'Write back an architectural decision as a proposed entry.',
        {
            ...
            content: z
                .string()
                .describe('The decision description and rationale'),
            scope: z
                .string()
                .default('global')
                .describe("Scope: 'global' or a file/module path"),
        },
        async (input) => ({
            content: [
                {
                    type: 'text' as const,
                    text: JSON.stringify(
                        handleProposeDecision(ctx, input),
                        null,
                        2
                    ),
                },
    ...
    server.tool(
        ...
        'Write back a constraint as a proposed entry.',
        {
            ...
            content: z
                .string()
                .describe('The constraint rule description'),
            scope: z
                .string()
                .default('global')
                .describe("Scope: 'global' or a file/module path"),
            ...
            content: [
                {
                    type: 'text' as const,
                    text: JSON.stringify(
                        handleProposeConstraint(ctx, input),
                        null,
                        2
                    ),
                },
    ...
    server.tool(
        ...
        'Captures a developer correction or instruction for DNA processing.',
        {
            instruction: z
                .string()
                .describe(
                    'The developer\'s instruction or correction'
                ),
            sessionId: z
                .string()
            ...
            isExplicit: z
                ...
                .default(false)
                .describe(
                    'True if the developer explicitly stated a preference'
                ),
        },
        async (input) => ({
            content: [
                {
                    type: 'text' as const,
                    text: JSON.stringify(
                        handleRecordInstruction(ctx, input),
                        null,
                        2
                    ),
                },
